...
func (m *MockClient) GetApplicationLogsV2(ctx context.Context, nameOrUUID string) (*meroxa.Logs, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetApplicationLogsV2", ctx, nameOrUUID)
	ret0, _ := ret[0].(*meroxa.Logs)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetApplicationLogsV2 indicates an expected call of GetApplicationLogsV2.
func (mr *MockClientMockRecorder) GetApplicationLogsV2(ctx, nameOrUUID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetApplicationLogsV2", reflect.TypeOf((*MockClient)(nil).GetApplicationLogsV2), ctx, nameOrUUID)
}
...
func (m *MockClient) GetBuildLogsV2(ctx context.Context, uuid string) (*meroxa.Logs, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBuildLogsV2", ctx, uuid)
	ret0, _ := ret[0].(*meroxa.Logs)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetBuildLogsV2 indicates an expected call of GetBuildLogsV2.
func (mr *MockClientMockRecorder) GetBuildLogsV2(ctx, uuid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBuildLogsV2", reflect.TypeOf((*MockClient)(nil).GetBuildLogsV2), ctx, uuid)
}
