...
require (
	...
	github.com/meroxa/meroxa-go v0.0.0-20211103221523-e3a079318047
...
replace github.com/meroxa/meroxa-go => github.com/meroxa/meroxa-go v0.0.0-20211103233400-d15cb8d865d8
