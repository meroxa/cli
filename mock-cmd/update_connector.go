...
// Source: cmd/meroxa/root/connectors/update.go
...
func (m *MockUpdateConnectorClient) UpdateConnector(ctx context.Context, connectorKey string, connector meroxa.UpdateConnectorInput) (*meroxa.Connector, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateConnector", ctx, connectorKey, connector)
...
func (mr *MockUpdateConnectorClientMockRecorder) UpdateConnector(ctx, connectorKey, connector interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateConnector", reflect.TypeOf((*MockUpdateConnectorClient)(nil).UpdateConnector), ctx, connectorKey, connector)
}
