...
function __meroxa_perform_completion
    __meroxa_debug "Starting __meroxa_perform_completion"
...
function __meroxa_clear_perform_completion_once_result
    ...
    __meroxa_debug "Successfully erased the variable __meroxa_perform_completion_once_result"
end
...
function __meroxa_prepare_completions
    ...
    if test $nospace -ne 0; or test $nofiles -eq 0
        ...
        __meroxa_debug "prefix: $prefix"

        set -l completions (string match -r -- "^$prefix.*" $__meroxa_comp_results)
        set --global __meroxa_comp_results $completions
        __meroxa_debug "Filtered completions are: $__meroxa_comp_results"

        # Important not to quote the variable for count to work
        set -l numComps (count $__meroxa_comp_results)
        ...
        if test $numComps -eq 1; and test $nospace -ne 0
            ...
            if not string match -r -q "[@=/:.,]" -- "$lastChar"
                ...
                set --global __meroxa_comp_results $split[1] $split[1].
                __meroxa_debug "Completions are now: $__meroxa_comp_results"
            end
        end
